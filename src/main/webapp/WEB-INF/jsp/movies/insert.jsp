			...
			<form:form role="form" action="app/movie/insert" method="post"
				...
				<div class="form-group">
					...
					<form:errors path="filmSummary">
						<div class="alert alert-danger" role="alert">Invalid Summary</div>
					</form:errors>
				</div>
					<div class="form-group">
				...
				<%-- <div class="form-group">
					<label for="filmCreationDate">Enter Creation Date</label>
					<form:input type="text" name="filmCreationDate" path="filmCreationDate"
						id="datepicker" />
					<form:errors path="filmCreationDate">
						<div class="alert alert-danger" role="alert">Invalid
							Creation Date</div>
					</form:errors>
				</div> --%>
				<div class="form-group">
					...
					<form:input type="text" name="filmReleaseDate" path="filmReleaseDate"
						id="datepicker" />
