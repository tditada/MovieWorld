...
public class MovieBuilder implements Cloneable {
	...
	protected Director value$director$ar$edu$itba$paw$model$Director;
	protected boolean isSet$director$ar$edu$itba$paw$model$Director;
	...
	public MovieBuilder withDirector(Director value) {
		this.value$director$ar$edu$itba$paw$model$Director = value;
		this.isSet$director$ar$edu$itba$paw$model$Director = true;
		return self;
	}
	...
	public Movie build() {
		try {
			Movie result = new Movie(value$releaseDate$org$joda$time$DateTime,
					...
					value$director$ar$edu$itba$paw$model$Director,
